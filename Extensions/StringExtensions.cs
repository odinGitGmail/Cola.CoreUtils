...
public static class StringExtensions
{
    ...
    public static JObject AddMailMark(this object entity, string fieldName, string newfieldName)
    {
        ...
        throw new Exception(EnumException.RegexEmail.GetDescription());
    }
        ...
        string? strMark = null)
    {
        ...
        throw new Exception(EnumException.RegexIdCardNumber.GetDescription());
    }
        ...
        string? strMark = null)
    {
        ...
        throw new Exception(EnumException.RegexPhoneNumber.GetDescription());
    }
